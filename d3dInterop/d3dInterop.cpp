...
extern "C"
{
	...
	dllexport HRESULT WINAPI Compile(
		LPCVOID pSrcData,
		SIZE_T SrcDataSize,
		LPCSTR pSourceName,
	...
	dllexport HRESULT WINAPI Disassemble(
		LPCVOID pSrcData,
		SIZE_T SrcDataSize,
		UINT Flags,
		LPCSTR szComments,
	...
	dllexport HRESULT WINAPI Preprocess(
		LPCVOID pSrcData,
		SIZE_T SrcDataSize,
		LPCSTR pSourceName,
		const D3D_SHADER_MACRO *pDefines,
	...
	{
		return D3DPreprocess(pSrcData, SrcDataSize, pSourceName, pDefines,
